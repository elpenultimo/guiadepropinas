...
export default function PaisesClient() {
  ...
  const [continente, setContinente] = useState<Continente | "todos">(() =>
    normalizeContinente(searchParams.get("continente"))
  );

  useEffect(() => {
    setContinente(normalizeContinente(searchParams.get("continente")));
  }, [searchParams]);
